...
export class FuncionarioFormComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    this.funcionarioForm = new FormGroup ({
      ...
      cargoId: new FormControl(this.dadosFuncionario ? (this.dadosFuncionario as any).cargoId || '' : '', [Validators.required]),
      projetoId: new FormControl(this.dadosFuncionario ? (this.dadosFuncionario as any).projetoId || '' : '', [Validators.required]),
